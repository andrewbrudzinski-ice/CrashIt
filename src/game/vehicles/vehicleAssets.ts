 ...
 * pre-modelled 3D asset (CC0 Kenney "Car Kit", see LICENSE in the models dir)
 * loaded at runtime and driven by the existing physics. This file is the
 * `Vehicle Definition` layer:
 *
...
export const VEHICLES: VehicleDef[] = [
  { id: 'metro', name: 'Metro', category: 'compact', modelPath: `${BASE}/metro.glb`, paint: '#e0e3e7', damageMultiplier: 1.15, blurb: 'City compact hatch — light, nimble, crumples early.' },
  ...
  { id: 'vortex', name: 'Vortex', category: 'muscle', modelPath: `${BASE}/vortex.glb`, paint: '#c0202a', damageMultiplier: 0.92, blurb: 'Low, wide muscle sedan — long hood, big power.' },
  { id: 'falcon', name: 'Falcon S', category: 'sports', modelPath: `${BASE}/falcon.glb`, paint: '#d9631a', damageMultiplier: 1.05, blurb: 'Mid-engine sports coupe — track-bred silhouette.' },
  ...
  { id: 'titan', name: 'Titan', category: 'pickup', modelPath: `${BASE}/titan.glb`, paint: '#1f6f4a', damageMultiplier: 0.8, blurb: 'Work pickup — long wheelbase, open bed.' },
  { id: 'transit', name: 'Transit', category: 'van', modelPath: `${BASE}/transit.glb`, paint: '#e9ecef', damageMultiplier: 0.9, blurb: 'Panel van — big box, upright cabin.' },
];
